import { calculatorsList, Category } from '@/lib/calculators';
import Link from 'next/link';

export async function generateStaticParams() {
  const categories = Array.from(new Set(calculatorsList.map(c => c.category.toLowerCase())));
    ...
    <div className="w-full">
      <div className="mb-12">
        ...
        <p className="text-xl font-medium text-gray-800 mb-8 max-w-2xl">
          Browse our collection of free, embeddable calculators in the {slug} category.
        </p>
      </div>
