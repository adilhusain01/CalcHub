...
export default async function CalculatorPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="w-full">
      <Link href="/" className="inline-flex items-center text-sm font-bold text-black hover:underline mb-8 border-[2px] border-black px-4 py-2 rounded-xl bg-white shadow-[2px_2px_0_0_#000] hover:shadow-[4px_4px_0_0_#000] transition-shadow">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-5 flex flex-col pt-4">
          ...
          <div className="bg-[#a7e0a5] border-[3px] border-black rounded-[24px] p-6 mb-8 shadow-[4px_4px_0_0_#000]">
             <h3 className="font-black text-2xl text-black mb-2">Embed for Free</h3>
             <p className="text-base font-medium text-gray-800 mb-6">Drop this calculator into your site's HTML to give your visitors instant value.</p>
